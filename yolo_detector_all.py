...
def generate_class_colors(num_classes=80):
    """Genera colori casuali per ogni classe"""
    colors = {}
    random.seed(42)  # Per avere colori consistenti
                    ...
                    for r in results:
                        if r.boxes is not None:
                            for box in r.boxes:
                                ...
                                if draw_boxes:
                                    color = class_colors.get(cls_id, (0, 255, 0))  # Verde default se classe non trovata
